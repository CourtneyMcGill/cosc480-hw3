...
When /^(?:|I )fill in "([^"]*)" with "([^"]*)" and (?:|I )fill in "([^"]*)" with "([^"]*)" $/ do |field1, value1, field2, value2|
...
Then /^I should see product price in sorted order$/ do
  slinky = page.body.index("slinky")
  ball = page.body.index("ball")
  fluffy = page.body.index("fluffy bunny")
  if slinky == 1 && ball == nil && fluffy == nil
  end
end

Then /^I should see product name in sorted order$/ do
  first = page.body.index("ball")
  second = page.body.index("fluffy bunny")
  third = page.body.index("slinky")
...
Then /^I should see that "(.*?)" has a price of "(.*?)"$/ do |arg1, arg2|
  page.find('tr', :text => arg1, :text => arg2)
end

Then /^I should see that "(.*?)" has an image "(.*?)"$/ do |arg1, arg2|
  page.find('tr', :text => arg1, :visible => arg2)
end

Then /^I should see the image "(.*?)"$/ do |arg1|
  page.should have_xpath('//*', :visible => arg1)
end
